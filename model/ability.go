...
func GetChannel(group string, model string, retry int) (*Channel, error) {
	return GetChannelWithExcludedAndRequestPath(group, model, retry, nil, "")
}

func GetChannelWithRequestPath(group string, model string, retry int, requestPath string) (*Channel, error) {
	return GetChannelWithExcludedAndRequestPath(group, model, retry, nil, requestPath)
}

func GetChannelWithExcluded(group string, model string, retry int, excludedIDs map[int]struct{}) (*Channel, error) {
	return GetChannelWithExcludedAndRequestPath(group, model, retry, excludedIDs, "")
}

func GetChannelWithExcludedAndRequestPath(group string, model string, retry int, excludedIDs map[int]struct{}, requestPath string) (*Channel, error) {
	var abilities []Ability
