...
func grantTopUpInviteRebateTx(tx *gorm.DB, topUp *TopUp, quota int, currency string) error {
...
func RechargeEpay(tradeNo string, actualPaymentMethod string, callerIp string) (alreadyDone bool, err error) {
	...
	err = DB.Transaction(func(tx *gorm.DB) error {
		...
		return grantTopUpInviteRebateTx(tx, topUp, quotaToAdd, "CNY")
	})
	if err != nil {
...
func Recharge(referenceId string, customerId string, callerIp string) (err error) {
	...
	err = DB.Transaction(func(tx *gorm.DB) error {
		...
		return grantTopUpInviteRebateTx(tx, topUp, quota, "USD")
	})
...
func ManualCompleteTopUp(tradeNo string, callerIp string) error {
	...
	err := DB.Transaction(func(tx *gorm.DB) error {
		...
		if err := grantTopUpInviteRebateTx(tx, topUp, quotaToAdd, "USD"); err != nil {
			return err
		}
...
func RechargeWaffo(tradeNo string, callerIp string) (err error) {
	...
	err = DB.Transaction(func(tx *gorm.DB) error {
		...
		return grantTopUpInviteRebateTx(tx, topUp, quotaToAdd, setting.WaffoCurrency)
	})
...
func RechargeWaffoPancake(tradeNo string) (err error) {
	...
	err = DB.Transaction(func(tx *gorm.DB) error {
		...
		return grantTopUpInviteRebateTx(tx, topUp, quotaToAdd, setting.WaffoPancakeCurrency)
	})
