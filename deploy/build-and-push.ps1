...
Write-Host "  $image"
Write-Host ""
Write-Host "Production update commands:"
...
Write-Host ""
Write-Host "Enterprise update commands:"
Write-Host "  docker-compose --env-file deploy/.env.enterprise -f deploy/compose.enterprise.yml pull new-api"
Write-Host "  docker-compose --env-file deploy/.env.enterprise -f deploy/compose.enterprise.yml up -d new-api"
