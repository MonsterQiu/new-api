...
func registerChannelRoutes(apiRouter *gin.RouterGroup) {
	...
	channelRoute.POST("/codex/oauth/start",
		middleware.RequirePermission(authz.ChannelSensitiveWrite),
		controller.StartCodexOAuth,
	)
	channelRoute.POST("/codex/oauth/complete",
		middleware.RequirePermission(authz.ChannelSensitiveWrite),
		controller.CompleteCodexOAuth,
	)
	channelRoute.POST("/:id/codex/oauth/start",
		middleware.RequirePermission(authz.ChannelSensitiveWrite),
		controller.StartCodexOAuthForChannel,
	)
	channelRoute.POST("/:id/codex/oauth/complete",
		middleware.RequirePermission(authz.ChannelSensitiveWrite),
